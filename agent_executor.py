...
class HelloAgent:
    """1. 랭체인과 OpenAI를 사용한 간단한 Hello World 에이전트."""
...
class HelloAgentExecutor(AgentExecutor):
    """3. 간단한 Hello World 에이전트의 Executor"""
    ...
    async def execute(
        ...
        # 5. 응답 메시지를 생성하고 이벤트 큐에 추가 (스트리밍을 위해 큐를 사용하는 것.)
