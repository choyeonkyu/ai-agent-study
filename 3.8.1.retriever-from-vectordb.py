...
# 1. retriever 생성
## search_type에 similarity는 유사도 기반 검색방식을 사용
##               MMR(Maximal Marginal Relevance) 방식은 관련성과 다양성을 동시에 사용하여 중복문서를 줄이는 방식
##               similarity_score_threshold 방식은 유사도 점수가 임계값 이하인 문서를 필터링 하는 방식
